...
public class PlayerMonsters {
    ...
    private Integer originalTrainerId;
    ...
    public PlayerMonsters() {
    }

    public PlayerMonsters(Integer ivHp, Integer id, Integer playerId, Integer speciesId, String nickname, Integer level, Integer currentHp, Integer experience, Integer ivAttack, Integer ivDefense, Integer ivSpAttack, Integer ivSpDefense, Integer ivSpeed, Integer evHp, Integer evAttack, Integer evDefense, Integer evSpAttack, Integer evSpDefense, Integer evSpeed, Integer natureId, Integer abilityId, Boolean isShiny, Integer friendship, String statusCondition, Integer originalTrainerId, LocalDateTime caughtAt, String caughtLocation, Boolean inTeam, Integer teamSlot, Integer pcBox, Integer pcSlot) {
        this.ivHp = ivHp;
        this.id = id;
    ...
    public PlayerMonsters(String name, Integer playerId) {
        this.name = name;
        this.playerId = playerId;
    }
    ...
    public boolean equals(Object o) {
        ...
        PlayerMonsters that = (PlayerMonsters) o;
